## 🕷️ Spiderlings Pricing Summary

**Scrape time (UTC):** `2026-01-15T07:51+00:00`
...
### 🚀 Top 5 Price Movers
| Species | Size | Old | New | Change |
|---|---|---:|---:|---:|
| Abdomegaphobema mesomelas | 2 | £100.00 | £100.00 | 0.0% |
| Acanthoscurria chacoana | 1 | £30.00 | £30.00 | 0.0% |
| Aphonopelma moderatum | 0.5 | £30.00 | £30.00 | 0.0% |
| Brachypelma hamorii | 2 | £15.00 | £15.00 | 0.0% |
| Ceratogyrus darlingi | 2 | £6.00 | £6.00 | 0.0% |

## 🧬 Breeder Opportunity Matrix (Top 10)

| Species | Size (cm) | OOS | OOS Runs | Stock Pattern | Price Trend | Wishlist Pressure | Wishlist Delta | Signal | Recommendation |
|---|---:|---|---:|---|---|---|---|---|---|
| Phormictopus sp. “Azul” | 2 | OUT | 2 | Emerging | → | 🔥 | ↑ | 🔥 | Consider pairing — emerging scarcity with surging interest |
| Brachypelma hamorii | 2 | IN | 0 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |
| Lasidora subcanens | 1 | IN | 0 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |
| Dolichothele rufoniger | 1 | OUT | 1 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Grammostola pulchripes | 1 | OUT | 1 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Aphonopelma chalcodes | 1 | IN | 0 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Avicularia purpurea | 2 | IN | 0 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Avicularia variegata | 2 | IN | 0 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Chilobrachys natanicharum | 1 | IN | 0 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |
| Chrom. cyaneopubescens | 2 | IN | 0 | Always | → | 🔥 | → | ⚠️ | Watch closely — high latent demand |

_Showing top 10 of 99 entries — see `breeder_opportunity_table.csv` for full list._

## 🏪 Dealer Supply Risk Matrix (Top 10)

| Species | Size (cm) | Stock Reliability | Avg OOS Duration | Restock Speed | Price Pressure | Wishlist Pressure | Wishlist Delta | Dealer Risk | Dealer Recommendation |
|---|---:|---|---:|---|---|---|---|---|---|
| Phormictopus sp. “Azul” | 2 | Medium | 2.0 | Moderate | → | 🔥 | ↑ | 🔥 | Actively seek breeders — surging demand, variable supply |
| Aphonopelma chalcodes | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Avicularia purpurea | 2 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Avicularia variegata | 2 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Chilobrachys natanicharum | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Chrom. cyaneopubescens | 2 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Cyriocosmus elegans | 0.5 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Davus sp. “Panama” | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Ewok cyaneolum (Blue) | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Hapalopus vangoghi | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
...
- **Signal:** 🔥
- **Recommendation:** Pair soon — sustained scarcity with strong buyer interest
...
- **Price Trend:** ↑ (£25 → £30)
- **Signal:** 🔥
- **Recommendation:** Consider pairing — rising demand
...
- **Signal:** ⚠️
- **Recommendation:** Breed cautiously — wave restocking
...
- **OOS Runs:** 2
- **Stock Pattern:** Emerging
- **Wishlist Pressure:** 🔥 (carried from last seen)
- **Wishlist Delta:** ↑ (+10)
- **Signal:** 🔥
...
- **OOS Runs:** 0
- **Stock Pattern:** Always
- **Wishlist Delta:** ↓ (20 → 15 → 8)
- **Signal:** ❌
- **Recommendation:** Avoid for profit — interest declining
...
- **Wishlist Pressure:** 🔥
- **Dealer Risk:** ❌
- **Recommendation:** Well-supplied, but monitor demand
...
- **Stock Reliability:** High (<40% availability)
- **Avg OOS Duration:** 0 runs
- **Restock Speed:** Fast
- **Dealer Risk:** ❌
- **Recommendation:** Well-supplied, but monitor demand
...
- **Stock Reliability:** Medium (1/6 weeks)
- **Wishlist Pressure:** 🔥 (carried from last seen)
- **Dealer Risk:** ⚠️
- **Recommendation:** Buy opportunistically — moderate demand, variable supply
...
- **Wishlist Pressure:** 🔥
- **Wishlist Delta:** ↑ (+14 from first to last)
- **Dealer Risk:** 🔥
- **Recommendation:** Actively seek breeders — surging demand, variable supply
...
- **Wishlist Delta:** ↓
- **Dealer Risk:** ❌
- **Recommendation:** No urgency / oversupplied — interest declining
...
**Scrape time (UTC):** `2026-01-19T20:04+00:00`
...
| Species | Size | Old | New | Change |
|---|---|---:|---:|---:|
| Ephebopus cyanognathus | 1 | £22.00 | £25.00 | +13.6% |
| Acanthoscurria chacoana | 1 | £30.00 | £30.00 | 0.0% |
| Amazonius germani | 2 | £7.00 | £7.00 | 0.0% |
| Aphonopelma chalcodes | 1 | £20.00 | £20.00 | 0.0% |
| Aphonopelma moderatum | 0.5 | £30.00 | £30.00 | 0.0% |
...
| Species | Size (cm) | OOS | OOS Runs | Stock Pattern | Price Trend | Wishlist Pressure | Wishlist Delta | Signal | Recommendation |
|---|---:|---|---:|---|---|---|---|---|---|
| Phormictopus sp. “Azul” | 2 | OUT | 3 | Emerging | → | 🔥 | ↑ | 🔥 | Consider pairing — emerging scarcity with surging interest |
| Aphonopelma anax | 1 | OUT | 4 | Sustained | → | ❌ | → | 🔥 | Pair soon — sustained scarcity |
| Harpactira namaquensis | 1 | OUT | 4 | Sustained | → | ❌ | → | 🔥 | Pair soon — sustained scarcity |
| Melopoeus albostriatum | 1 | OUT | 4 | Sustained | → | ❌ | → | 🔥 | Pair soon — sustained scarcity |
| Phormingochilus everetti | 3 | OUT | 4 | Sustained | → | ❌ | → | 🔥 | Pair soon — sustained scarcity |
| Lasidora subcanens | 1 | OUT | 1 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |
| Davus sp. “Panama” | 1 | IN | 0 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |
| Ewok cyaneolum (Blue) | 1 | IN | 0 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |
| Grammostola pulchripes | 1 | IN/OUT | 0 | Cyclical | → | 🔥 | ↑ | ⚠️ | Breed cautiously — wave restocking |
| Hapalopus vangoghi | 1 | IN | 0 | Always | → | 🔥 | ↑ | ⚠️ | Watch closely — high latent demand |

_Showing top 10 of 105 entries — see `breeder_opportunity_table.csv` for full list._
...
| Ewok cyaneolum (Blue) | 1 | Low | 4.0 | Slow | → | 🔥 | ↑ | 🔥 | Actively seek breeders — high demand, poor supply |
| Hapalopus vangoghi | 1 | Low | 4.0 | Slow | → | 🔥 | ↑ | 🔥 | Actively seek breeders — high demand, poor supply |
| Phormictopus sp. “Dom Purple” | 2 | Low | 4.0 | Slow | → | 🔥 | ↑ | 🔥 | Actively seek breeders — high demand, poor supply |
| Theraphosa blondi | 4 | Low | 4.0 | Slow | → | 🔥 | ↑ | 🔥 | Actively seek breeders — high demand, poor supply |
| Phormictopus sp. “Azul” | 2 | Medium | 3.0 | Slow | → | 🔥 | ↑ | 🔥 | Actively seek breeders — surging demand, variable supply |
| Cilantica psychadelicus | 2 | Low | 5.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Lasiocyano sazmai | 1 | Low | 5.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Aphonopelma chalcodes | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
| Chilobrachys natanicharum | 1 | Low | 4.0 | Slow | → | 🔥 | → | 🔥 | Actively seek breeders — high demand, poor supply |
